...
val coroutinesBom: Dependency = dependencies.platform("org.jetbrains.kotlinx:kotlinx-coroutines-bom:1.8.0")
val hiltVersion: String by rootProject.extra
val lifecycleVersion = "2.7.0"
val composeBom: Dependency = dependencies.platform("androidx.compose:compose-bom:2024.04.01")
val composeAccompanistVersion = "0.34.0"
