...
internal class Network(activity: Activity, db: AppDatabase) {
    ...
    private val wifiFrequency: Item
        get() {
    ...
    private val wifiHiddenSSID: Item
        get() {
    ...
    private val wifiIpAddress: Item
        get() {
    ...
    private val wifiLinkSpeed: Item
        get() {
    ...
    private val wifiNetworkID: Item
        get() {
    ...
    private val bluetoothHostname: Item
        get() {
    ...
    private val simOperatorName: Item
        get() {
    ...
    private val voicemailNumber: Item
    ...
    private val cellNetworkName: Item
        get() {
    ...
    private val cellNetworkType: Item
        get() {
